...
<div class="container">
    ...
    <form:form action="update" commandName="posts" class="form-horizontal" method="post">    
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
            	<textarea id="texto" name="texto" class = "form-control" rows = "3">${post.texto}</textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date" class = "form-control"  id="data" name="data" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${post.data}" />">
